...
const PrintPanelQuarterly = () => {
  const location = useLocation();
  const { year, quarter, tableData, issueCounts } = location.state;
...
export default PrintPanelQuarterly;
